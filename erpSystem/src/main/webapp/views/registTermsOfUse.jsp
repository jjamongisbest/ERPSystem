...
<link rel="stylesheet" href="../resources/registTermsOfUse.css">
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
</head>
<body>
	<form class="contract" action="../service">
		<input type="hidden" name="command" value="getregist">
		<h2>회원가입 약관</h2>
		<div class="checkbox">
			<div class="check-box">
		...
		<div>
			<p>
				<input type="submit" value="다음" class="box">
			<p>
		</div>
	</form>
